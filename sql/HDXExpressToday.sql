/*Same day HDXpress Batch file, From existing query. Inigo San Gil, Apr 2017*/
...
where 
CONVERT(CHAR(8),SCH.APP_DTTM,112) = @DATE
...
and INS.Payer_Type = 4000 /*GENERAL_INSURANCE*/
and INS.Inactive = 0
and VWPAT.General_Secondary_Payer_Name like '**%' and Payer.HCFA_PAYERID like '0%'
